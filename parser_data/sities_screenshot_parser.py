...
site_urls = pd.read_csv('parser_data/top-1m.csv')
...
for idx, row in site_urls.iterrows():
    ...
    try:
        ...
        print(f"Ошибка при доступе к {site_url}: {traceback_info}")
    ...
    print(f'Сделан скриншот для страницы: {site_url} и сохранен в файл {screenshot_name}')
